...
class BitInputStream final {
	...
	public: explicit BitInputStream(std::vector<char> &in);
...
class BitOutputStream final {
	...
	private: std::vector<char> output;
	...
	public: explicit BitOutputStream();
	...
	public: int get(std::vector<char> *p);
